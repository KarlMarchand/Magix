...
namespace magix_api.Migrations
{
    ...
    [Migration("20230228213726_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("magix_api.DeckCard", b =>
                {
                    b.Property<int>("DeckIdRef")
                        .HasColumnType("INTEGER");

                    b.Property<int>("CardIdRef")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("DeckIdRef", "CardIdRef");

                    b.HasIndex("CardId");

                    b.HasIndex("CardIdRef");
            ...
            modelBuilder.Entity("magix_api.DeckCard", b =>
                {
                    ...
                    b.HasOne("magix_api.Card", "Card")
                        .WithMany()
                        .HasForeignKey("CardIdRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("magix_api.Deck", "Deck")
                        .WithMany("DeckCard")
                        .HasForeignKey("DeckIdRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
