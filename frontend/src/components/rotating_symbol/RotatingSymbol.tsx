...
const RotatingSymbol: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, ...props }) => {
	...
	return (
		<div
			{...props}
			className={`${className ? className : ""} rotating-symbol`}
			style={{ animation: "rotateSymbol 20s linear infinite" }}
		>
